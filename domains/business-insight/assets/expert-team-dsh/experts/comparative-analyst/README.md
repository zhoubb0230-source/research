...
| | |
|---|---|
| name / agentId | `comparative-analyst` |
| 动作 | ⑤ 刻画 ⑥ 聚合 |
| provider 路由 | `deepseek-high` |
| 人格与技能正本 | [`../../../expert-team/experts/comparative-analyst/`](../../../expert-team/experts/comparative-analyst/) |
...
```jsonc
{
  "name":        "comparative-analyst",          // 不可变，且名字永不复用（含建失败的）
  "description": "📊 对比分析专家 —— 负责骨架的 ⑤ 刻画 ⑥ 聚合",
  "prompt":      <.dsh/PROMPTS/comparative-analyst.md 正文>,   // ← 人格在这里绑上去
...
⚠️ 「不取数」在 dsh 上只能靠 prompt —— 工具面无法逐队友收窄，它实际拿得到 web 工具。

## 在 dsh 上落不下去的约束

`../../../expert-team/experts/comparative-analyst/expert.yaml` 里的 `tools.need` / `tools.deny`
