...
| `ai-coding` | AI Coding 工具 | 编码助手与 Agent（Claude Code、Cursor、Copilot 等）、代码生成/评测、研发流程集成 | [domains/ai-coding/INDEX.md](domains/ai-coding/INDEX.md) | 5 |
...
| 日期 | 领域 | 条目 | 变更 |
|---|---|---|---|
| 2026-08-12 | ai-coding | ai-coding-insight-0003 | 新增《编码 Agent 的外挂记忆中间件：OpenViking、Mem0 与同类工具横向洞察》，并入「记忆与上下文管理」专题 |
| 2026-08-12 | ai-coding | ai-coding-insight-0002 | 新增《AI Coding 工具的记忆与上下文管理》，并在领域索引建立「专题」分组 |
